...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-root', default='./data/checker3/', dest='data_root', type=str, help='Location of data X with labels.')
    ...
    parser.add_argument('--N', default=3000, help='Size of Checkerboard dataset to create')
    ...
    if not os.path.exists(args.data_root + 'X_labels.npz'):
        ...
        X, labels = create_checkerboard3(args.N)
