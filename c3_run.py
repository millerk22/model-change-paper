...
if __name__ == "__main__":
    ...
    parser.add_argument('--tau-gr', default=0.1, dest='tau_gr', type=float, help='value of diagonal perturbation and scaling of MGR (not HF)')
    parser.add_argument('--gamma-gr', default=0.1, dest='gamma_gr', type=float, help='value of noise parameter of MGR (not HF)')
    parser.add_argument('--tau-ce', default=0.05, dest='tau_ce', type=float, help='value of diagonal perturbation and scaling of CE model')
