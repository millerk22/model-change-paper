# Script for running AL experiment -- MULTICLASS
# author: Kevin Miller
import numpy as np
import argparse
import time
...
def many_experiments(root_filename, wM, vM, labels, num_runs=5, new=False):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = 'Run Active Learning experiment on Multiclass dataset')
    parser.add_argument('--save_root', default='./', type=str, help='Location to store the results of the experiment')
